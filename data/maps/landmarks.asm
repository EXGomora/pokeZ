...
SaltbreezeTownName:  db "SALTBREEZE<BSP>TOWN@"
SunglowTrailName:    db "SUNGLOW<BSP>TRAIL@"
SunglowCapeName:     db "SUNGLOW<BSP>CAPE@"
SunglowHarborName:   db "SUNGLOW<BSP>HARBOR@"
SunglowBeachName:   db "SUNGLOW<BSP>BEACH@"
SunglowCoveName:   db "SUNGLOW<BSP>COVE@"
SunglowCaveName:   db "SUNGLOW<BSP>CAVE@"
WhisperingMarshName:   db "WHISPERING<BSP>MARSH@"
